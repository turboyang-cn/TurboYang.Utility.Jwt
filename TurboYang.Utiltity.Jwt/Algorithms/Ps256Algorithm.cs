...
{
    public sealed class Ps256Algorithm : AsymmetricAlgorithm
    {
        internal Ps256Algorithm()
        {
        }

        public Ps256Algorithm(IPemPublicKey publicKey)
            : base(publicKey)
        {
        }

        public Ps256Algorithm(IPemPrivateKey privateKey)
            : base(privateKey)
        {
        }

        public Ps256Algorithm(String publicKey, String privateKey)
            : base(publicKey, privateKey)
        {
        }

        public Ps256Algorithm(PemKeyPair keyPair)
            : base(keyPair)
        {
        }

        public override String Name => "PS256";
